...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
		showMessage("Yaw博客的秘密通道：<br /> <a href=\"http://www.yawzhou.cn\" title=\"首页\">首页</a>    <a href=\"http://www.yawzhou.cn/feed\" title=\"订阅\">订阅</a>    <a href=\"http://weibo.com/yawzhou\" title=\"微博\">去微博</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.3);
       msgs = ["我隐身了，你看不到我", "哼，你再摸我，我告诉主人去！", "我会隐身哦！嘿嘿！", "别动手动脚的，把手拿开！", "把手拿开我才出来！"];
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        if (now > 0 && now <= 6) {
            ...
            showMessage(visitor + ' 欢迎来到主人的博客，快来逗我玩吧！', 6000);
        }
    }
    else {
        showMessage('欢迎' + visitor + '来到Yaw Zhou的博客 ' + title + ' ', 6000);
    }
    $(".spig").animate({
