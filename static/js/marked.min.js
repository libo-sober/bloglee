...
(function () {
    ...
    Renderer.prototype.blockquote = function (quote) {
        return "<blockquote class='blockquote-md'>\n" + quote + "</blockquote>\n"
    };
    ...
    Renderer.prototype.heading = function (text, level, raw) {
       return "<h" + level + 'data-id="12" id="' + this.options.headerPrefix + raw.toLowerCase().replace(/[^\w]+/g, "-") + '">' + text + "</h" + level + ">\n"
    };
    ...
    Renderer.prototype.image = function (href, title, text) {
        var out='<a class="fancybox-on" data-fancybox="gallery" data-type="image" href="'+href+'"';
        if (title) {
            out += ' data-caption="' + title + '"';
        }
        out += '><img onerror="javascript:this.src=\'/static/images/notfound.jpg\';" src="' + href + '" alt="' + text + '"';
